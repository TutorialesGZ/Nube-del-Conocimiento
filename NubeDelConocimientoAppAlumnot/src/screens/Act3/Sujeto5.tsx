...
export const Sujeto5 = ({navigation}:Props) => {
  ...
  const obtenerDatos = () =>{
    ...
    .then((respuestaJson) => {
      ...
      setHoracion(respuestaJson[4].pregunta);
      setRespuestaCorrecta(respuestaJson[4].respuesta);
      setRespuestaIncorrecta1(respuestaJson[4].respuestaIncorrecta1);
      setRespuestaIncorrecta2(respuestaJson[4].respuestaIncorrecta2);
