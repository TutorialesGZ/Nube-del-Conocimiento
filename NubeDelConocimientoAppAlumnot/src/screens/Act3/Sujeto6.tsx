...
export const Sujeto6 = ({navigation}:Props) => {
  ...
  const obtenerDatos = () =>{
    ...
    .then((respuestaJson) => {
      ...
      setHoracion(respuestaJson[5].pregunta);
      setRespuestaCorrecta(respuestaJson[5].respuesta);
      setRespuestaIncorrecta1(respuestaJson[5].respuestaIncorrecta1);
      setRespuestaIncorrecta2(respuestaJson[5].respuestaIncorrecta2);
