...
export const Sujeto9 = ({navigation}:Props) => {
  ...
  const obtenerDatos = () =>{
    ...
    .then((respuestaJson) => {
      ...
      setHoracion(respuestaJson[8].pregunta);
      setRespuestaCorrecta(respuestaJson[8].respuesta);
      setRespuestaIncorrecta1(respuestaJson[8].respuestaIncorrecta1);
      setRespuestaIncorrecta2(respuestaJson[8].respuestaIncorrecta2);
