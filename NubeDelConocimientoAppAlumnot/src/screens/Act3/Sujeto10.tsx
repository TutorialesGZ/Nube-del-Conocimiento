...
export const Sujeto10 = ({navigation}:Props) => {
  ...
  const obtenerDatos = () =>{
    ...
    .then((respuestaJson) => {
      ...
      setHoracion(respuestaJson[9].pregunta);
      setRespuestaCorrecta(respuestaJson[9].respuesta);
      setRespuestaIncorrecta1(respuestaJson[9].respuestaIncorrecta1);
      setRespuestaIncorrecta2(respuestaJson[9].respuestaIncorrecta2);
