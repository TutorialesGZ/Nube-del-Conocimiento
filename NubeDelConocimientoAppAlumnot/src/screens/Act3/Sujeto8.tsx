...
export const Sujeto8 = ({navigation}:Props) => {
  ...
  const obtenerDatos = () =>{
    ...
    .then((respuestaJson) => {
      ...
      setHoracion(respuestaJson[7].pregunta);
      setRespuestaCorrecta(respuestaJson[7].respuesta);
      setRespuestaIncorrecta1(respuestaJson[7].respuestaIncorrecta1);
      setRespuestaIncorrecta2(respuestaJson[7].respuestaIncorrecta2);
