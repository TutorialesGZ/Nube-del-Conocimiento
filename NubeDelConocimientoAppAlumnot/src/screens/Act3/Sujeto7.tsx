...
export const Sujeto7 = ({navigation}:Props) => {
  ...
  const obtenerDatos = () =>{
    ...
    .then((respuestaJson) => {
      ...
      setHoracion(respuestaJson[6].pregunta);
      setRespuestaCorrecta(respuestaJson[6].respuesta);
      setRespuestaIncorrecta1(respuestaJson[6].respuestaIncorrecta1);
      setRespuestaIncorrecta2(respuestaJson[6].respuestaIncorrecta2);
